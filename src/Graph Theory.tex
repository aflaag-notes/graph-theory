...
\begin{document}
    ...
    \begin{proof}
        Since we already discussed that $R(4) \ge 18$, the result follows immediately from the previous proposition because $R(4) \le 2 \cdot R(3, 4) \le 9 = 18$ --- and $R(3, 4) \le 9$ by the previous lemma.
    \end{proof}
