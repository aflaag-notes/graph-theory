...
\begin{document}
    ...
    TODO \todo{missing indset}

    Moreover, consider the following number.
    ...
    \begin{proof}
        Let $G_1$ be a single vertex, and consider a graph of such sequence $G_k$; we construct $G_{k + 1}$ inductively as follows:
