...
\begin{document}
    ...
    \begin{framedprob}{}
        Give an example of a 2-connected graph $G$ such that for any $C \subseteq G$ it holds that $G - C$ is disconnected.
    \end{framedprob}
    
    \solution{
        A minimal example is given by the following graph:
