...
\begin{document}
    ...
    In particular, we are going to define the following type of graph, named after \href{https://en.wikipedia.org/wiki/P%C3%A1l_Tur%C3%A1n}{Pál Turán}.
    ...
    Finally, we are going to prove Turán's theorem, proved by \textcite{turan} in 1941.
