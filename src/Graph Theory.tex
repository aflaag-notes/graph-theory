...
\begin{document}
    ...
    \begin{proof}
        ...
        Now, let $H$ be the subgraph of $G$ induced from the set of vertices that have color 2 and 4 in $G - \{u\}$; clearly, since $\chi(H) = 2$, it must be that $G$ is bipartite by \cref{bip col}. Let $C$ be che component of $H$ that contains $v_2$ TODO \todo{da finire}
    \end{proof}
