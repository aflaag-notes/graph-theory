...
\begin{document}
    ...
    \begin{proof}
        ...
        Lastly, let $P_2$ be such that $C = P_1 \cup P_2$ and $P_1$ and $P_2$ are internally disjoint; the last observation implies that $\mathcal N (y) - \{x\}$ lies completely on $P_2$
