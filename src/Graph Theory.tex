...
\begin{document}
    ...
    Unformally, we could say that every 3-connected graph can be constructed by repeatedly \curlyquotes{unconstructing} edges. \todo{maybe other direction of prev cor?}
