...
\begin{document}
    ...
    \proofind{
        ...
        Let $C$ be a cycle of $H$, and consider the graph $H - C$.
    ...
    \begin{itemize}
        ...
        \item if both endpoints of an edge are cut vertices, the edge \tit{may not} be a bridge
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[-,>=stealth,shorten >=1pt,auto,node distance=1.5cm, thick,main node/.style={scale=0.9,circle,draw,font=\sffamily\normalsize}]
                    ...
                    \node[circle, draw] (6) [below of = 1, yshift=-2cm]{6};
                    ...
                    ;
                \end{tikzpicture}
                \caption{For instance, in this graph the vertices 2 and 3 are both cut vertices, but the edge $\{2, 3\}$ is not a bridge.}
            \end{figure}
    ...
    \begin{framedprop}{}
        Given a graph $G$, and two distinct blocks $H, H'$ of $G$, it holds that $\abs{V(H) \cap V(H')} \le 1$.
    \end{framedprop}
    ...
    \begin{proof}
        ...
        Hence, the only possibility is that $H \cup H'$ contains at least 3 vertices.

        However, if for any $z \in V(H \cup H')$ it holds that $(H \cup H') - \{z\}$ is connected, and $\abs{V(H \cup H')} \ge 3$, it implies that $H \cup H'$ is 2-connected by definition. This means that $H \cup H'$ does not contain cut vertices, contradicting the maximality of the blocks $H, H' \subsetneq H \cup H'$ $\lightning$.
    \end{proof}
