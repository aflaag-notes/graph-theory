...
\begin{document}
    ...
    Here, the term \tbf{homeomorphic} refers to the existence of an \tit{homeomorphism} between the two sets, i.e. a continuous function between them whoch inverse is also continuous. In particulr, for the case of polygonal arcs the images of 0 and 1 under such homeomorphism are the \tbf{endpoints} of the arc.
