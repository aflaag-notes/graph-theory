...
\begin{document}
    ...
    \proofind{
        ...
        Finally, if $H'$ contains $k$ disjoint cycles, and $H - C$ has $H'$ as topological minor, i.e. $H - C$ contains a subdivision $H''$ of $H'$, by definition of the subdivision operation $H''$ will contain $k$ disjoint cycles as well. Therefore, since $H - C$ contains $H''$, $H$ contains $k$ disjoint cycles along with the cycle $C$.
    }
